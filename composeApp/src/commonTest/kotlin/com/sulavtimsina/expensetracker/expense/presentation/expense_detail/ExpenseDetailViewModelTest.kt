...
class ExpenseDetailViewModelTest {
    ...
    @Test
    fun `load expense succeeds when expense exists`() =
        runTest {
            // Given
            val expense =
                Expense(
    ...
    @Test
    fun `load expense fails when expense does not exist`() =
        runTest {
            // Given
    ...
    @Test
    fun `delete expense fails when repository returns error`() =
        runTest {
            // Given
            val expense =
                Expense(
