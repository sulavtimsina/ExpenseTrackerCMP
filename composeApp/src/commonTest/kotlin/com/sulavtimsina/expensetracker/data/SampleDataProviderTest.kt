...
class SampleDataProviderTest {
    ...
    @Test
    fun `insertSampleData inserts sample expenses when none exist`() =
        runTest {
    ...
    @Test
    fun `insertSampleData does not insert when sample data already exists`() =
        runTest {
    ...
    @Test
    fun `insertSampleData handles repository errors gracefully`() =
        runTest {
    ...
    @Test
    fun `sample data contains variety of categories`() =
        runTest {
            // Given
            fakeRepository.setExpenses(emptyList())
    ...
    @Test
    fun `sample data contains reasonable amounts`() =
        runTest {
            // Given
            fakeRepository.setExpenses(emptyList())
    ...
    @Test
    fun `sample data has variety of dates`() =
        runTest {
            // Given
            fakeRepository.setExpenses(emptyList())
    ...
    @Test
    fun `minusDays extension function works correctly with fixed date scenario`() =
        runTest {
    ...
    @Test
    fun `sample data includes all expense categories`() =
        runTest {
            // Given
            fakeRepository.setExpenses(emptyList())
    ...
    @Test
    fun `sample data includes both expenses with and without notes`() =
        runTest {
            // Given
            fakeRepository.setExpenses(emptyList())
    ...
    @Test
    fun `sample data includes realistic expense descriptions`() =
        runTest {
            // Given
            fakeRepository.setExpenses(emptyList())
