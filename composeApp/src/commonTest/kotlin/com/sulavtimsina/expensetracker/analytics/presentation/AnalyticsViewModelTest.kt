...
class AnalyticsViewModelTest {
    ...
    @Test
    fun `onAction SelectPeriodType updates period and loads data`() =
        runTest {
            // Given
            val mockExpenses =
                listOf(
    ...
    @Test
    fun `onAction ApplyCustomDateRange applies custom date range`() =
        runTest {
            // Given
    ...
    @Test
    fun `loadAnalyticsData sets data in state`() =
        runTest {
            // Given
            val mockExpenses =
                listOf(
