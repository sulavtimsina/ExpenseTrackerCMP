...
import com.sulavtimsina.expensetracker.analytics.domain.DailyData
import com.sulavtimsina.expensetracker.analytics.domain.MonthlyData
...
private fun DrawScope.drawMonthlyLineChart(
...
private fun DrawScope.drawDailyLineChart(
    data: List<DailyData>,
    progress: Float,
) {
    if (data.isEmpty()) return
