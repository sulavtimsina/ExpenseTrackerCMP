package com.sulavtimsina.expensetracker.expense.data.database
...
class ExpenseDatabaseSource(
    ...
    fun getAllExpenses(): Flow<List<com.sulavtimsina.expensetracker.database.Expense>> {
        return queries.selectAllExpenses()
            .asFlow()
            .mapToList(Dispatchers.Default)
    }

    suspend fun getExpenseById(id: String): com.sulavtimsina.expensetracker.database.Expense? {
    ...
    fun getExpensesByCategory(category: String): Flow<List<com.sulavtimsina.expensetracker.database.Expense>> {
